...
var PymakrView = function () {
  function PymakrView(serializedState, pyboard) {
    ...
    // terminal logic
    var term = new _terminal2.default(this.terminal_el, this.pyboard);
    this.terminal = term;
      ...
      if (address == "" || address == null) {
        ...
        var onconnect = function onconnect(err) {
          ...
          if (err) {
            ...
            vscode.window.showInputBox({ prompt: 'Type your command' }).then(function (val) {
              return _this.userInput(val + "\r\n");
            });
          }
