...
module.exports = class Utils {
  ...
  /**
   * Returns input as array. If input is an array, the array is returned.
   * @param {string|string[]} subject 
   * @param {string=} delimiter 
   * @returns {string[]}
   */
  static coerceArray = (subject , delimiter) => typeof subject === 'string' ? subject.split(delimiter) : subject
