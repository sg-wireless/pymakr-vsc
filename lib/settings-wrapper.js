...
var SettingsWrapper = function (_EventEmitter) {
  ...
  function SettingsWrapper() {
    ...
    _this2.address = _this2.api.config().get('address');
    _this2.username = _this2.api.config().get('username');
    _this2.password = _this2.api.config().get('password');
    _this2.sync_file_types = _this2.api.config().get('sync_file_typesaddress');
    _this2.sync_folder = _this2.api.config().get('sync_folder');
    _this2.ctrl_c_on_connect = _this2.api.config().get('ctrl_c_on_connect');
    _this2.open_on_start = _this2.api.config().get('open_on_start');
  ...
  _createClass(SettingsWrapper, [{
    ...
    value: function openGlobalSettings(cb) {
      var _this = this;
