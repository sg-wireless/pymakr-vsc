...
var PymakrView = function () {
  function PymakrView(serializedState, pyboard, settings) {
    ...
    this.terminal = new _terminal2.default(onTermConnect, this.pyboard, settings);
  ...
  _createClass(PymakrView, [{
    ...
    key: 'createStatusItem',
    value: function createStatusItem(name, command, tooltip) {
      if (!this.statusItemPrio) {
        this.statusItemPrio = 10;
      }
      var statusBarItem = vscode.window.createStatusBarItem(_vscode.StatusBarAlignment.Left, this.statusItemPrio);
    ...
    value: function showQuickPick() {
      ...
      _vscode.window.showQuickPick(items, options).then(function (selection) {
        if (typeof selection === "undefined") {
          return;
        }

        _vscode.commands.executeCommand(selection.cmd);
    ...
    value: function getSerial() {
      ...
      _pyserial2.default.list(function (list) {
    ...
    value: function sync() {
      ...
      this.syncObj = new _sync2.default(this.pyboard, this.settings);
