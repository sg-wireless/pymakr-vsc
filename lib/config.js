module.exports = {
  constants: {
    ...
    help_text:
      'Pymakr VSC Plugin Help. Commands to use (cmd/ctrl + p):\r\n' +
  ...
  settings: {
    ...
    fast_upload: {
      ...
      description:
        'Uses bigger batches and compresses larger (>4kb) files to make uploading faster. Only works on newer devices with 4mb of ram and firmware version >=1.19.x',
      order: 12,
    },
    py_ignore: {
      title: 'Pyignore list',
